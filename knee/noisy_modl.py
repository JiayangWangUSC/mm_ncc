...
#recon_modol = torch.load("/project/jhaldar_118/jiayangw/mm_ncc/model/modl_mae_acc6")
...
for epoch in range(max_epochs):
    ...
    torch.save(recon_model,"/project/jhaldar_118/jiayangw/mm_ncc/knee/model/modl_mae_acc8")
