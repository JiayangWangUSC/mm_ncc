...
recon_modol = torch.load("/project/jhaldar_118/jiayangw/mm_ncc/model/modl_mse_acc4")
...
for epoch in range(max_epochs):
    ...
    torch.save(recon_model,"/project/jhaldar_118/jiayangw/mm_ncc/model/modl_mse_acc4")
