...
def data_transform(kspace, ncc_effect, sense_maps):
    ...
    return kspace, ncc_effect, sense_maps
...
recon_model = torch.load("/project/jhaldar_118/jiayangw/mm_ncc/model/modl_ncc_acc3")
# %% training settings
...
for epoch in range(max_epochs):
    ...
    for kspace, ncc_effect, sense_maps in train_dataloader:
        ...
        torch.save(recon_model,"/project/jhaldar_118/jiayangw/mm_ncc/model/modl_ncc_acc3")
